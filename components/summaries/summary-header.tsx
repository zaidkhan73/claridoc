      ...
      <div className="self-start">
        <Link href="/dashboard">
          <Button
            variant={"link"}
            size="sm"
            className="group flex items-center gap-1 sm:gap-2 hover:bg-white/100 backdrop-blur-xs rounded-full transition-all duration-200 shadows-xs hover:shadow-md border border-rose-100/30 bg-rose-100 px-2 sm:px-3 hover:no-underline"
          >
